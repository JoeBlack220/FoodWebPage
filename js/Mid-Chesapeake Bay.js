...
function drawFoodChains(index){
  ...
  for(let i = 0; i < predatorCor.length; i++){
   ...
   p.textSize(15);
   p.loadStrings("./data/Mid-Chesapeake Bay/info/" + curName + ".txt", setDesc);
...
class Species {
  ...
  constructor(speciesRow, bigCircleDia, idx, total, columnNum){
    ...
    for(let i = 0; i < columnNum ; i++){
      ...
      this.img = p.loadImage("./data/Mid-Chesapeake Bay/pics/" + this.name + ".jpg");
